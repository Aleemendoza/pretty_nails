    ...
    <Container maxWidth="lg">
      ...
      >
        ...
        Términos y Condiciones
            ...
            Estos términos y condiciones describen las reglas y regulaciones para el uso del sitio web de My Pretty Nails, ubicado en https://myprettynails.com/.

            Al acceder a este sitio web, asumimos que aceptas estos términos y condiciones. No continúes usando My Pretty Nails si no estás de acuerdo con todos los términos y condiciones establecidos en esta página.

            Cookies:

            El sitio web utiliza cookies para ayudar a personalizar tu experiencia en línea. Al acceder a My Pretty Nails, aceptaste utilizar las cookies necesarias.
            ...
            A menos que se indique lo contrario, My Pretty Nails y/o sus licenciantes poseen los derechos de propiedad intelectual de todo el material en My Pretty Nails. Todos los derechos de propiedad intelectual son reservados. Puedes acceder desde My Pretty Nails para tu uso personal sujeto a las restricciones establecidas en estos términos y condiciones.

            No debes:

            Copiar o volver a publicar material de My Pretty Nails
            Vender, alquilar o sublicenciar material de My Pretty Nails
            Reproducir, duplicar o copiar material de My Pretty Nails
            Redistribuir contenido de My Pretty Nails
        ...
        <Box>
          Garantizas y declaras que:
            ...
            Por la presente, otorgas a Hello Nails una licencia no exclusiva para usar, reproducir, editar y autorizar a otros a usar, reproducir y editar cualquiera de tus comentarios en todas y cada una de las formas, formatos, o medios.
            ...
            Si eres una de las organizaciones enumeradas en el párrafo 2 y estás interesada en vincularte a nuestro sitio web, debes informarnos enviando un correo electrónico a Hello Nails. Incluye tu nombre, el nombre de tu organización, la información de contacto, así como la URL de tu sitio, una lista de las URL desde las que tienes la intención de vincular a nuestro sitio web y una lista de las URL de nuestro sitio a las que te gustaría acceder. Espera 2-3 semanas para recibir una respuesta.
            ...
            No se permitirá el uso del logotipo de Hello Nails u otro material gráfico para vincular sin un acuerdo de licencia de marca comercial.

  ...
  return (
    <Container style={{ textAlign: 'center', padding: '16px' }}>
      <Typography variant="h4" style={{ marginBottom: '16px', color: '#1976D2' }}>
        ¡Descubre el prettyNails con Nosotros!
      </Typography>
      ...
      <Typography variant="body1" style={{ marginTop: '16px', marginBottom: '16px' }}>
        Al registrarte, tendrás la oportunidad de explorar los lugares más emblemáticos del prettyNails de la mano de guías turísticos apasionados. Desde majestuosas catedrales hasta encantadoras plazas, cada recorrido te sumergirá en la belleza y la historia de esta época fascinante.
      </Typography>
      <Typography variant="body1" style={{ marginTop: '16px', marginBottom: '16px' }}>
